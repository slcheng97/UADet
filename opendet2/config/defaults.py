...
def add_opendet_config(cfg):
    ...
    _C.OWOD = CN()
    _C.OWOD.START_ITER = 0
    _C.OWOD.PREV_INTRODUCED_CLS = 0
    _C.OWOD.CUR_INTRODUCED_CLS = 20
    _C.OWOD.SCORE_THRESH = 0.
    _C.OWOD.FINE_TUNING = False


def add_gdino_config(cfg):
    _C = cfg
    config_file = "/home/slcheng/Documents/code/opendet_jiaming/GroundingDINO/groundingdino/config/GroundingDINO_SwinB_cfg.py"
    cfg1 = SLConfig.fromfile(config_file)
