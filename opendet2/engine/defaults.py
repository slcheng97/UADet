...
from detectron2.engine import (AMPTrainer, SimpleTrainer,
                               TrainerBase, create_ddp_model, create_ddp_model, default_writers)
from detectron2.evaluation import (DatasetEvaluator, DatasetEvaluators, print_csv_format,
                                   verify_results)
...
# from ..data_owod import build_detection_train_loader_owod, build_detection_test_loader_owod
from ..evaluation import PascalVOCDetectionEvaluator, PascalVOCDetectionEvaluator_OWOD, inference_on_dataset
from . import hooks
...
class OpenDetTrainer(TrainerBase):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type == "pascal_voc":
            # return PascalVOCDetectionEvaluator_OWOD(dataset_name, cfg)
